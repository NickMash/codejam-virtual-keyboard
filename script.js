...
const Keyboard = {
    row1: [{keyCode: '192', name: 'Backquote', simbols: ['ё','Ё','`','~'], class: 'key'},
        ...
        {keyCode: '189', name: 'Minus', simbols: ['-','_','-','_'], class: 'key minus'},
        {keyCode: '187', name: 'Equal', simbols: ['=','+','=','+'], class: 'key equal'},
    ...
    row2: [{keyCode: '9', name: 'Tab', simbols: ['Tab','Tab','Tab','Tab'], class: 'key tab'},
        ...
        {keyCode: '220', name: 'Backslash', simbols: ['\\','/','\\','|'], class: 'key backslash'},
